...
void Palette_Init(uint8_t LCD_Mode)
{
  ...
  ILI9341_Clear(0,0,LCD_X_LENGTH,LCD_Y_LENGTH);	
	...
	//插入空格，居中显示	
	sprintf(cStr,"%*c%s",((LCD_X_LENGTH/(((sFONT *)LCD_GetFont())->Width))-strlen(pStr))/2 + 2,' ',pStr)	;	
  ILI9341_DispStringLine_EN (LCD_Y_LENGTH >> 1, cStr );	
	
	LCD_SetTextColor(CL_BLACK);
	//插入空格，居中显示	
	sprintf(cStr,"%*c%s",((LCD_X_LENGTH/(((sFONT *)LCD_GetFont())->Width))-strlen(pStr))/2 + 2,' ',pStr)	;	
  ILI9341_DispStringLine_EN (LCD_Y_LENGTH / 2 + 16 * 2, cStr );	
...
void Touch_Button_Init(void)
{
  ...
  button[6].para = CL_BUTTON_GREY;
  button[6].touch_flag = 0;  
  button[6].draw_btn = Draw_Clear_Button ;
  button[6].btn_command = Command_Clear_Palette ;
...
//  button[7].btn_command = Command_Clear_Palette ;
  ...
  button[7].end_y = COLOR_BLOCK_HEIGHT;
  button[7].para = SHANG_SHENG;
  button[7].touch_flag = 0;  
  button[7].draw_btn = Draw_Shape_Button ;
  button[7].btn_command = Command_Select_Brush ;
  
  button[8].start_x = BUTTON_START_X + COLOR_BLOCK_WIDTH;
  button[8].start_y = COLOR_BLOCK_HEIGHT;
  button[8].end_x = BUTTON_START_X + COLOR_BLOCK_WIDTH*2 ;
  button[8].end_y = COLOR_BLOCK_HEIGHT*2;
  button[8].para = XIA_JIANG;
  ...
  button[9].start_y = COLOR_BLOCK_HEIGHT*2;
  button[9].end_x = BUTTON_START_X + COLOR_BLOCK_WIDTH*2 ;
  button[9].end_y = COLOR_BLOCK_HEIGHT*3;
  button[9].para = SHANG_SHENG;
  ...
  button[10].start_y = COLOR_BLOCK_HEIGHT*3;
  button[10].end_x = BUTTON_START_X + COLOR_BLOCK_WIDTH*2 ;
  button[10].end_y = COLOR_BLOCK_HEIGHT*4;
  button[10].para = XIA_JIANG;
  ...
  button[11].start_y = COLOR_BLOCK_HEIGHT*4;
  button[11].end_x = BUTTON_START_X + COLOR_BLOCK_WIDTH*2 ;
  button[11].end_y = COLOR_BLOCK_HEIGHT*5;
  button[11].para = RUBBER;
  ...
  button[12].start_y = COLOR_BLOCK_HEIGHT*5;
  button[12].end_x = BUTTON_START_X + COLOR_BLOCK_WIDTH*2 ;
  button[12].end_y = COLOR_BLOCK_HEIGHT*6;
  button[12].para = RUBBER;
  ...
  button[13].start_y = COLOR_BLOCK_HEIGHT*6;
  button[13].end_x = BUTTON_START_X + COLOR_BLOCK_WIDTH*2 ;
  button[13].end_y = COLOR_BLOCK_HEIGHT*7;
  button[13].para = RUBBER;
